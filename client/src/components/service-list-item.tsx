...
export default function ServiceListItem({ service }: ServiceListItemProps) {
  ...
  return (
    <div className={`rounded-xl overflow-hidden p-4 sm:p-6 flex flex-col sm:flex-row sm:items-center space-y-4 sm:space-y-0 sm:space-x-6 ${
      isFeatured 
      ...
      <img 
        ...
        className="w-20 h-20 sm:w-24 sm:h-24 object-cover rounded-lg flex-shrink-0 mx-auto sm:mx-0"
      ...
      {/* Action Icons */}
      <div className="flex justify-center items-center gap-1 sm:grid sm:grid-cols-5 flex-shrink-0">
        <Button
          asChild
          variant="ghost"
          size="sm"
          className={`p-0 h-16 px-2 rounded-none w-auto sm:w-full ${
            isFeatured 
        ...
        <Button
          ...
          variant="ghost"
          size="sm"
          className="p-0 hover:bg-gray-100 h-16 px-2 rounded-none w-auto sm:w-full"
          data-testid={`service-list-whatsapp-${service.id}`}
        >
